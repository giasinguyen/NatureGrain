    ...
    <footer className="bg-gray-800 text-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <Link to="/" className="flex items-center mb-4">
              <img
                src="/Naturegrain-Footer.png"
                alt="NatureGrain Logo"
                className="h-20 w-auto"
              />
            </Link>
            <p className="mb-4 text-gray-300">
              NatureGrain là nhà cung cấp thực phẩm hữu cơ hàng đầu, mang đến
              những sản phẩm chất lượng cao từ thiên nhiên, đảm bảo an toàn và
              tốt cho sức khỏe.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span>
                  Hotline:{" "}
                  <a href="tel:+84977123456" className="hover:text-green-400">
                    034.899.6487
                  </a>
                </span>
              </li>
      ...
      <div className="bg-gray-900 py-4">
        <div className="container mx-auto px-4 text-center text-gray-400 text-sm">
          <p>
            © {new Date().getFullYear()} NatureGrain - Tất cả các quyền được bảo
            lưu
          </p>
